<?php
// ---------------------------------------------------------------
// $Id: Class.VaultDiskDirCache.php,v 1.1 2001/11/16 09:57:01 marc Exp $
...
// ---------------------------------------------------------------
// $Log: Class.VaultDiskDirCache.php,v $
...
Class VaultDiskDirCache extends VaultDiskDir {
  ...
  function VaultDiskDirCache($vault, $def='', $id_dir='') {
    VaultDiskDir::VaultDiskDir($vault, "cache", $id_dir);
  }
