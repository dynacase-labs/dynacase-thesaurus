<?php
// ---------------------------------------------------------------
// $Id: Class.VaultDiskDirStorage.php,v 1.1 2001/11/16 09:57:01 marc Exp $
...
Class VaultDiskDirStorage extends VaultDiskDir {
  ...
  function VaultDiskDirStorage($vault, $def='', $id_dir='') {
    VaultDiskDir::VaultDiskDir($vault, "storage", $id_dir);
  }
