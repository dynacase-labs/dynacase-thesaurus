...
// Transfer to CORE ?
  ...
  array( "acl" => "WGCAL_USER", "name" => "WGCAL_STOREEVENT", 
   ...
   array( "acl" => "WGCAL_USER", "name" => "WGCAL_SAVEEVENT", 
         "short_name" =>N_("save event"), "toc" => "N", "root" =>"N"),
 array( "acl" => "WGCAL_USER", "name" => "WGCAL_DELETEEVENT", 
  ...
  array( "acl" => "WGCAL_USER", "name" => "WGCAL_GETJSEVENT", "short_name" =>N_("get event js format"), "toc" => "N", "root" =>"N"),
  array( "acl" => "WGCAL_USER", "name" => "WGCAL_DCAL", "short_name" =>N_("dyn calendar view"), "toc" => "N", "root" =>"N"),
  ...
  array( "acl" => "WGCAL_MGR", "name" => "WGCAL_ROOMSCARS", "toc" => "N"),
  array( "acl" => "WGCAL_MGR", "name" => "WGCAL_CHOOSEGROUPS", "toc" => "N"),
  array( "acl" => "WGCAL_MGR", "name" => "WGCAL_CATEDIT", "toc" => "N"),
