 ...
 *
 * @author Anakeen 2000 
 * @version $Id: popupdoc.php,v 1.1 2006/04/20 07:02:39 eric Exp $
...
function popupdoc(&$action) {
  ...
  foreach($lmenu as $k=>$v) {
    ...
    $tlink[$k]["tconfirm"]=utf8_encode(sprintf(_("Sure %s ?"),addslashes($v->labelText)));
