...
function popupcard(&$action) {
  ...
  popupInit('popupcard',  array('editdoc','unlockdoc','histo','properties','cancel'));
  ...
  if ($cud || $clf)   popupActive('popupcard',$kdiv,'editdoc');
  else                popupInactive('popupcard',$kdiv,'editdoc');
