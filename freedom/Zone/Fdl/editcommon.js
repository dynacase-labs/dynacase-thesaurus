...
function changeFile(o,nid) {
  ...
  var p;
  if (t && o) {
    t.value=(o.value=='')?document.getElementById('INIV'+nid).value:o.value;     
...
function  nodereplacestr(n,s1,s2) {
  ...
  var rs1;
  var tmp;
  var attnames = new Array('onclick','href','onmousedown','onmouseover','id','name','onchange','oncontextmenu','src');
  // for regexp
  rs1 = s1.replace('[','\\[');
  rs1 = rs1.replace(']','\\]');
